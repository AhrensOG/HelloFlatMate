...
(async () => {
  try {
    ...
    //OWNER
    Owner.hasMany(LeaseOrderRoom, {
      as: "leaseOrdersRoom",
      foreignKey: "ownerId",
    });
    Owner.hasMany(LeaseOrderProperty, {
    ...
    Property.hasMany(LeaseOrderRoom, {
      as: "leaseOrdersRoom",
      foreignKey: "propertyId",
    });
    Property.belongsTo(Owner, { as: "owner", foreignKey: "ownerId" });
    Property.hasMany(LeaseOrderProperty, {
      as: "leaseOrdersProperty",
      foreignKey: "propertyId",
    });
    ...
    LeaseOrderProperty.belongsTo(Property, {
      foreignKey: "propertyId",
      as: "property",
    }); // Usar el correcto foreignKey
    LeaseOrderProperty.belongsTo(Client, {
      foreignKey: "clientId",
      as: "client",
    });
    ...
    LeaseOrderRoom.belongsTo(Property, {
      foreignKey: "propertyId",
      as: "property",
    });
    ...
    //CLIENT
    Client.hasMany(LeaseOrderProperty, {
      as: "leaseOrdersProperty",
      foreignKey: "clientId",
    });
    Client.hasMany(LeaseOrderRoom, {
      as: "leaseOrdersRoom",
      foreignKey: "clientId",
    });
    ...
    //NOTIFICATION
    Notification.belongsTo(Client, { as: "client", foreignKey: "clientId" });
    Payment.belongsTo(Owner, { as: "owner", foreignKey: "ownerId" });
    ...
    Client.hasMany(Notification, {
      ...
      as: "notifications",
      scope: {
        notifiableType: "CLIENT",
      },
    });

    // Owner
    Owner.hasMany(Notification, {
      foreignKey: "notifiableId",
      constraints: false,
      as: "notifications",
      scope: {
        notifiableType: "OWNER",
      },
    });
    ...
    // Notification belongs to Client, Owner or Admin

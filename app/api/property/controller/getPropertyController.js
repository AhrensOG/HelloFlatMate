import { Category, Client, Document, LeaseOrderProperty, LeaseOrderRoom, Owner, Property, RentalItem, RentalPeriod, Room } from "@/db/init";
            ...
            include: [
                ...
                },
                {
                    ...
                    include: {
                        model: Client,
                        as: "client",
                        attributes: ["id", "name", "lastName", "email", "profilePicture", "emergencyName", "emergencyPhone", "emergencyEmail"],
                        include: {
                            model: Document,
                            as: "documents",
                        },

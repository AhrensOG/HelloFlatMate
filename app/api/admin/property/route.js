...
import { activateProperty, cascadeUpdateByCategory, updateProperty, updateSimpleProperty } from "./controller/updateProperty";
...
export async function PATCH(req) {
    ...
    if (simple == "true") {
        const result = await updateSimpleProperty(data);
        return result;
    }

...
<body>
  ...
  <p>
    Para que tu reserva en Calle ${address.street} ${address.streetNumber} P${address.door} ${getLastTwoDigits(serial)} esté confirmada debes acceder a tu área de usuario, apartado <strong>“reservas”</strong>, y realizar el pago del <strong>primer mes de alquiler</strong> dentro de las próximas <strong>2 horas</strong>.
  </p>
  <p>

const hellolandlordContractTemplate = ({
    ...
    De una parte, D./Dª ${landlordName}, como parte ARRENDADORA, siendo mayor de edad, con NIF ${landlordNIF}, propietario/a en pleno dominio del inmueble sito en Valencia: C/ ${landlordStreet} nº ${landlordStreetNumber} - PUERTA ${landlordDoorNumber}, Valencia ${landlordPostalCode}.\n
...
6. Se penalizará con 100€ cualquier falta de respeto, insultos, etc., hacia el arrendador, la agencia, los trabajadores de mantenimiento y limpieza, o los propios compañeros.\n

7. El arrendatario no podrá hacer uso de las habitaciones de la vivienda que no se encuentren arrendadas, y si efectivamente lo hace, podrá ser detraído el 100% de la cantidad entregada en concepto de fianza.\n

const hellocolivingContractTemplate = ({
  ...
  De otra parte, D./Dª  ${tenantName}, mayor de edad, con D.N.I o pasaporte  ${tenantID}, nº de teléfono +${tenantPhone}, email  ${tenantEmail}, y con domicilio en ${tenantAddress}, C/ ${tenantStreet}\n
  actuando como parte ARRENDATARIA, está interesado en arrendar la habitación n.º H${roomNumber} del mencionado inmueble\n
  ...
  De realizar la entrega más tarde, sin que hubiera ejercitado la facultad de contratar una noche extra, el ARRENDATARIO abonará al ARRENDADOR la cantidad de 35 € por cada día de retraso en la puesta a\n
  disposición de las llaves, en concepto de cláusula penal, además de todos los gastos que directos e indirectos que dicho retraso generen de cara a la recuperación de la vivienda y de la habitación.\n
  \n
  ...
  \n
  10. Visitas-Se puede recibir visitas en el piso siempre y cuando se informe a los compañeros y al propietario a través del grupo de Whatsapp y los compañeros estén de acuerdo. La duración de la estancia es de máximo 3 noches y no pueden coincidir más de 3 invitados de manera simultánea en la vivienda.\n
  \n

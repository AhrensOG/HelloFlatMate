  ...
  return (
    <section className="bg-white w-full">
      ...
      <div className="max-w-screen-lg mx-auto py-16 px-4">
        ...
        <div className="space-y-8 text-lg text-center">
          <p>
            ...
            <br />
            <br />
            Nos ocupamos de gestionar todos los aspectos de tu estancia, desde
            que llegas hasta que finalices tu contrato.
            <br />
            <br />
            Ofrecemos una selección de habitaciones en pisos compartidos,
            exclusivamente diseñadas para estudiantes y nómadas digitales de
            hasta 30 años, creando un ambiente de convivencia adaptado a tu
            estilo de vida. Además, operamos en las mejores zonas de la ciudad,
            como Blasco Ibáñez, el Centro y Moncada, para que siempre estés
            cerca de tu universidad o lugar de trabajo.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-screen-lg mx-auto py-16 px-4">
        ...
        <div className="space-y-8 text-lg text-center">
          <p>
            Fundada por Alberto Borrás, es más que una agencia de servicios para
            estudiantes. Es un proyecto pensado para garantizar una atención
            personalizada y exclusiva a jóvenes recién llegados a Valencia,
            asegurando que su experiencia sea fluida, segura y adaptada a sus
            necesidades.
            <br />
            <br />
            ...
            <br />
            <br />
            Cargado con más equipaje del que podía manejar, sin alojamiento
            reservado porque no se fiaba, comenzó a soñar con un servicio que
            hiciera más fácil la llegada a un lugar desconocido.
            <br />
            <br />
            ¿Te imaginas que alguien nos esperara al llegar a Londres, nos
            ayudara con las maletas, los papeles y guiara en esos primeros
            días?", recuerda Alberto haber pensado. <br />
            <br />
            Esa idea evolucionó hasta convertirse en una solución integral para
            estudiantes internacionales y nacionales que buscan alojamiento en
            Valencia.
            <br />
            <br />
            El objetivo no era sólo encontrar un espacio donde vivir, sino
            proporcionar un acompañamiento real en cada paso del proceso, desde
            la llegada hasta la integración. <br />
            <br />
            ...
            servicio cercano que crea un impacto positivo en las vidas de los
            estudiantes. <br />
            <br />
            Respecto al futuro, Alberto y su equipo se muestran optimistas,
            aunque prefieren centrarse en el presente y seguir ofreciendo un
            servicio de calidad. "El día a día está lleno de retos, pero los
            agradecimientos de las familias y los estudiantes son lo que nos
            impulsa a seguir adelante", afirma.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-around items-center space-y-8 md:space-y-0 md:space-x-4">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <Link
              ...
              className="text-blue-600 underline mt-4"
            >
              Estudiantes internacionales de la UCV dispondrán de facilidades
              para el alojamiento en apartamentos
            </Link>
          </div>
          <div className="flex flex-col items-center text-center">
            <Image
            ...
            <Link
              ...
              className="text-blue-600 underline mt-4"
            >
              La importancia de alquilar un buen piso para estudiantes en
              Valencia
            </Link>
          </div>
        </div>

    ...
    return (
        <section className="bg-white w-full">
            ...
            <header className="bg-[url('/home/new_home/bg1.png')] bg-cover bg-no-repeat bg-center">
                ...
                <div className="w-full flex justify-center items-center py-40">
                    <h1 className="text-2xl font-bold max-w-screen-lg text-center text-white">
                        helloflatmate es la plataforma online de alquiler de pisos y habitaciones de media y larga estancia
                    </h1>
                </div>
            </header>
            ...
            <div className="max-w-screen-lg mx-auto py-16 px-4">
                <h2 className="text-center text-2xl font-bold mb-8">¿Por qué es diferente helloflatmate?</h2>
                <div className="space-y-8 text-lg text-center">
                    <p>
                        ...
                        <br />
                        En <strong>helloflatmate</strong>, nos especializamos en ofrecer alojamiento para estudiantes y nómadas digitales que buscan
                        ...
                        <br />
                        <br />A diferencia de otras opciones, en <strong>helloflatmate</strong> garantizamos un proceso de reserva claro y eficiente,
                        eliminando complicaciones desde el primer día.
                        <br />
                        <br />
            ...
            <div className="max-w-screen-lg mx-auto py-16 px-4">
                <h2 className="text-center text-2xl font-bold mb-8">Así comenzó helloflatmate: una idea que nació en movimiento</h2>
                <div className="space-y-8 text-lg text-center">
                    <p>
                        ...
                        <br />
                        <br />
                        La inspiración para <strong>helloflatmate</strong> surgió mientras Alberto vivía en Bristol (Inglaterra), concretamente cuando
                        se mudaba a Londres.
                        <br />
                        <br />
                        ...
                        <strong>helloflatmate</strong> fue pionera en priorizar la adaptación de los jóvenes y su tranquilidad, ofreciendo mucho más
            ...
            <div id="medios" className="max-w-screen-lg mx-auto py-16 px-4">
                <h2 className="text-center text-4xl font-bold mb-14">helloflatmate en los medios</h2>

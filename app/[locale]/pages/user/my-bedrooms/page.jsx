...
export default function MyBedrooms() {
  const t = useTranslations("user_panel");
    ...
    if (state.user) {
      ...
      if (filtered.length > 0 && !showDetails) {
        handleShowDetails({
          ...
          type:
            filtered[0].room?.property?.category ||
            filtered[0].property?.category,
          location: {
            street:
              filtered[0].room?.property?.street ||
              filtered[0].property?.street,
            postalCode:
              filtered[0].room?.property?.postalCode ||
              filtered[0].property?.postalCode,
            city:
              filtered[0].room?.property?.city || filtered[0].property?.city,
          },
          dueDate: {
          ...
          amenities:
            filtered[0].room?.proprty?.amenities ||
            filtered[0].property?.amenities ||
            [],
          id:
            filtered[0].propertyId ||
            filtered[0].id ||
            filtered[0].property?.id,

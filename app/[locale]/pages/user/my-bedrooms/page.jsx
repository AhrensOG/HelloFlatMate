        ...
        if (state.user) {
            ...
            if (filtered.length > 0 && !showDetails) {
                handleShowDetails({
                    ...
                    type: filtered[0].room?.property?.category || filtered[0].property?.category,
                    location: {
                            ...
                            <div className="flex w-full max-w-screen-xl h-[calc(100vh-93px)]">
                                ...
                                >
                                    {propertiesList.length > 0 ? (
                                        ...
                                        <p className="text-center text-xl font-medium text-slate-400">{t("desktop.dont_have_rooms")}</p>
                                    )}
                                </motion.div>
                                ...
                                >
                                    {selectedRoom ? (
                                        ...
                                        <p className="text-center text-xl font-medium text-slate-400">{t("desktop.p")}</p>
                                    )}
                                </motion.div>
                            </div>
                        </div>

        ...
        <section className="bg-white w-full">
            ...
            <header className="bg-[url('/home/new_home/colaboradores.png')] bg-cover bg-no-repeat bg-center">
                ...
                <div className="w-full flex justify-center items-center py-40">
                    <h1 className="text-2xl font-bold max-w-screen-lg text-center text-white"></h1>
                </div>
            </header>

            {/* Grid de Universidades */}
            <div id="universidades" className="max-w-screen-lg mx-auto py-16 px-4">
                <h2 className="text-center text-4xl font-bold mb-14">Universidades de la Comunidad Valenciana</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {universities.map((university, index) => (
                        <div key={index} className="flex flex-col items-center text-center shadow-lg rounded-lg p-4">
                            <Link href={university.url} target="_blank">
                                <Image src={university.logo} alt={university.name} width={150} height={150} className="rounded-md" />
                            </Link>

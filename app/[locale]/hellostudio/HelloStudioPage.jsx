...
export default function HelloStudioPage() {
    ...
    const filterByRentalPeriod = (properties) => {
        ...
        return properties.filter((property) => {
            ...
            if (property.category === "HELLO_ROOM" || property.category === "HELLO_COLIVING" || property.category === "HELLO_LANDLORD" || property.category === "HELLO_STUDIO") {
            ...
            <div className="flex flex-col sm:min-h-screen">
                ...
                <div className="w-full flex flex-col">
                    <div className="flex flex-col gap-8 bg-white items-center justify-around py-10 px-2">
                        <h1 className="text-3xl font-bold">hellostudio</h1>
                        <h2 className="text-lg text-center">{HTMLReactParser(formatedStrongText(t("h2")))}</h2>

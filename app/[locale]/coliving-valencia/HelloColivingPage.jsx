...
import HelloColivingTextSection from "@/app/components/public/main-pages/HelloColivingTextSection";
        ...
        <div className="w-full flex flex-col">
          <div className="flex flex-col gap-8 bg-white items-center justify-around py-10 px-2">
            ...
            <p className="text-lg text-center max-w-screen-md">
              Descubre el <strong>coliving en Valencia</strong> con{" "}
              <strong>helloflatmate</strong>, una opción moderna y flexible para
              estudiantes, profesionales jóvenes y nómadas digitales. Vive en{" "}
              <strong>pisos compartidos</strong> completamente equipados, con
              servicios incluidos y espacios pensados para tu comodidad y
              productividad.
              <br />
              <br />
              Conecta con otros residentes, disfruta de una experiencia única y
              vive en las mejores zonas de Valencia.
            </p>
          </div>
        </div>

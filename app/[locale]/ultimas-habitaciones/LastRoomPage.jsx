        ...
        <div className="w-full flex flex-col">
          <div className="flex flex-col gap-8 bg-white items-center justify-around py-10 px-2">
            ...
            <p id="subtitle" className="text-lg text-center max-w-screen-md">
              ...
              ¿Buscas una habitación en Valencia? Descubre las{" "}
              <strong>últimas habitaciones en alquiler en Valencia</strong> con{" "}
              <strong>helloflatmate</strong>. Habitaciones modernas, totalmente
              equipadas y en <strong>pisos compartidos</strong> bien ubicados,
              ideales para estudiantes y jóvenes profesionales.
              <br />
              <br />

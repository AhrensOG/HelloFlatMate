    ...
    >
      <header className="notification-header w-full mt-10">
        <nav className="notification-nav w-full flex pl-3 items-center">
          <button type="button" onClick={() => route.back()} className="">
            <Image
              src="/back-light.svg"
              layout="responsive"
              width={20}
      ...
      <main className="notification-main grow flex flex-col justify-center items-center gap-4">
        <Image
          ...
          src="/notification-big-icon.svg"
          layout="responsive"
          alt="Icono de Notificación Grande"
          width={100}
          height={100}
        />
        <section className="notification-section text-center text-base">
          <h2 className="notification-title font-semibold text-black">
            No tienes notificaciones ahora
          </h2>
          <p className="notification-text pt-2 font-light text-gris-español">
            No tienes notificaciones aún. Aquí se <br />
            mostrarán las
            <br />
            notificaciones cuando tengas alguna.
          </p>
        </section>
      </main>
    </div>

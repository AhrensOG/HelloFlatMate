...
export default function PropertyDetails({ params }) {
    ...
    const [data, setData] = useState(state.properties ? state.properties.find((property) => id === property.id) : null);
        ...
        <div className="flex flex-col justify-center items-center relative">
            ...
            <div className="flex flex-col max-w-screen-sm sm:hidden w-full gap-2 ">
                <header className="w-full space-y-4">
                    ...
                    <div className="px-3">
                        <NavBarDetails callBack={() => router.back() || router.push("/pages/user/filtered")} />
                    </div>
                </header>
                <main className={`  flex flex-col gap-[2.5rem] grow text-[#0D171C] w-full px-3`}>
                    ...
                    {data.price && data.category.name === "HELLO_STUDIO" ? <PriceSection data={data.price} /> : null}
            ...
            /> */}
                        {data.category.name === "HELLO_STUDIO" && <ReservationButton callback={handleShowModal} />}
                    </div>

                    {data.description && data.description?.length > 0 ? <DescriptionSection data={data.description} /> : ""}
                    ...
                    />
                    <RoomSection data={data.rooms} category={data.category.name} />

        ...
        <div className="w-full flex flex-col">
          <div className="flex flex-col gap-8 bg-white items-center justify-around py-10 px-2">
            ...
            <h3 id="subtitle" className="text-lg text-center max-w-screen-md">
              Alojamiento de larga estancia en estudios equipados, gestionados
              tanto por helloflatmate como por landlords confiables.
              <br />
              <br />
              Ideal para estudiantes y nómadas digitales que buscan comodidad y
              privacidad.
            </h3>
          </div>
        </div>

...
export default function NavBar() {
    ...
    return (
        <>
            ...
            <div className="h-full flex"> <Image className="ml-[4%] self-center" src="/nav_bar/nav-bar-logo.svg" layout="responsive" width={125} height={41} alt="Logo de FlatMate" /></div>

    ...
    return (
        <form className={`${plus_jakarta.className} text-[#A0A09F]`} role="search">
            <div className="flex gap-2 items-center justify-center">
                <div className="bg-black flex align-center w-[75%] h-[2.2rem] rounded-[0.6rem] border-[1px] border-[#00000033] gap-2">
                    ...
                    <input className="text-center rounded-[0.6rem] grow text-[0.93rem] font-medium outline-none" type="text" placeholder="Buscar..." aria-label="Buscar"></input>
                </div>

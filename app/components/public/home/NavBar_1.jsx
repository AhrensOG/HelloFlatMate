...
export default function NavBar_1() {
    ...
    return (
        <nav className="flex items-center justify-between py-2 px-10 border-b border-[#c7c7c7] relative">
                ...
                <button onClick={toggleMenu} aria-label="Toggle menu" className="absolute left-4">
                    ...
                    >
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g transform="translate(-15.000000, -21.000000)" fill="#666666" fill-rule="nonzero" stroke="#666666" stroke-width="0.75">
                                <path

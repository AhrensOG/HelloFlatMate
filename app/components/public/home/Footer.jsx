        ...
        <>
            ...
            <footer className="bg-[#f2efed] w-full flex flex-col gap-11 md:hidden py-10">
                ...
                <section className="flex flex-col gap-7 p-6">
                    ...
                    <button className="p-5 border border-[#676767] font-bold">Visita el centro de ayuda</button>
                    <Link href="#" target="_blank" className="font-normal text-base">
                ...
                <section className="flex flex-wrap gap-7 p-4 justify-center">
                    <h2 className="font-bold uppercase text-lg w-full">Metodos de pago</h2>
                    <Image src={"https://static.spotahome.com/images/paypal-logo.svg"} width={50} height={50} alt="paypal" />
                    <Image src={"https://static.spotahome.com/images/visa-logo.svg"} width={50} height={50} alt="visa" />
                    <Image src={"https://static.spotahome.com/images/mastercard-logo.svg"} width={50} height={50} alt="mastercard" />
                    <Image src={"https://static.spotahome.com/images/americanexpress-logo.svg"} width={50} height={50} alt="americanexpress" />
                    <Image src={"https://static.spotahome.com/images/unionpay-logo.svg"} width={50} height={50} alt="unionpay" />
                </section>

                <section className="flex flex-col gap-7 p-6">
                    <article className="flex flex-wrap justify-center gap-4">
                        <h2 className="font-bold uppercase text-lg w-full">DESCARGA LA APP</h2>
                        <button>
                            <Image src={"https://static.spotahome.com/login_image/app-store.png"} width={150} height={150} alt="app store" />
                        </button>
                        <button>
                            <Image src={"https://static.spotahome.com/login_image/google-play.png"} width={150} height={150} alt="google play" />
                        </button>
                    </article>
                    <article className="flex flex-wrap gap-4">
                        <h2 className="font-bold uppercase text-lg w-full">SIGUENOS</h2>
                        <Link href="#" target="_blank" className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 22" class="" aria-label="new-icon">
                                <g clip-path="url(#clip0_2905_1174)">
                                    <path
                        ...
                        <Link href="#" target="_blank" className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 19 22" class="" aria-label="my-icon">
                                <path
                        ...
                        <Link href="#" target="_blank" className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 23 22" class="" aria-label="new-icon">
                                <path
                        ...
                        <Link href="#" target="_blank" className="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 22 22" class="" aria-label="facebook-icon">
                                <g clip-path="url(#clip0_2905_1178)">
                                    <path
            ...
            <footer className="bg-[#f2efed] w-full flex-col gap-11 hidden md:flex py-10">
                <div className="flex justify-center gap-12 ">
                    ...
                    <section className="flex flex-col gap-7 p-6">
                        <h2 className="font-bold uppercase text-lg">Soporte</h2>
                        <button className="p-5 border border-[#676767] font-bold text-xl w-[15rem]">Visita el centro de ayuda</button>
                        <Link href="#" target="_blank" className="font-normal text-base">
                            Contacta con Soporte
                        </Link>
                    </section>

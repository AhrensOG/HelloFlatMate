    ...
    <>
      ...
      <footer className="bg-[#f5f2f1] w-full flex flex-col gap-11 md:hidden py-10">
        ...
        <section className="flex flex-wrap gap-7 p-4 justify-center">
          ...
          <Image
            src={"/home/new_home/paypal.svg"}
            width={50}
            height={50}
            alt="paypal"
          />
          <Image
            src={"/home/new_home/visa.svg"}
            width={50}
            height={50}
            alt="visa"
          />
          <Image
            src={"/home/new_home/mastercard.svg"}
            width={50}
            height={50}
            alt="mastercard"
          />
          <Image
            src={"/home/new_home/americanexpress.svg"}
            width={50}
            height={50}
            alt="americanexpress"
          />
          <Image
            src={"/home/new_home/unionpay.svg"}
            width={50}
            height={50}
            alt="unionpay"
          />
                ...
                <defs>
                  <clipPath id="clip0_2905_1174">
                    <rect
                      ...
                      height="20.9676"
                      fill="white"
                      transform="translate(0 0.516113)"></rect>
                  </clipPath>
                </defs>
              </svg>
            </Link>
                ...
                <defs>
                  <clipPath id="clip0_2905_1178">
                    <rect
                      ...
                      height="20.9676"
                      fill="white"
                      transform="translate(0.580872 0.516113)"></rect>
                  </clipPath>
                </defs>
              </svg>
            </Link>

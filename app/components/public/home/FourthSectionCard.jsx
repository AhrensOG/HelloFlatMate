...
export default function FourthSectionCard({ star, text, name, location }) {
    return (
        <motion.article
            ...
            className="flex flex-col gap-2 w-full min-w-72 sm:min-w-[47rem] max-w-[47vw] bg-[#F7F7F7] rounded-2xl p-4 text-center text-gray-600"
        >

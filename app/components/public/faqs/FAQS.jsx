    ...
    return (
        <main className="flex flex-col items-center gap-4 my-6 mx-2">
            <div className="flex flex-col items-center max-w-screen-xl">
                <h1 className="font-bold text-2xl text-resolution-blue w-full">Preguntas frecuentes</h1>
                        ...
                        {[
                            {
                                ...
                                answer: (
                                    <>
                                        ...
                                        <p>
                                            No tendrás que gestionar nada con el propietario del piso y dentro del horario de 9 a 17 horas siempre
                                ...
                                answer: (
                                    <>
                                        <p>
                                            ...
                                            acuerdo. Si la estancia de este invitado llega a la semana de duración, éste deberá aportar 20 €/semana
                                            para los gastos comunes del piso.
                                        </p>
                                        <br />
                            ...
                            },
                            {
                                ...
                                answer: (
                                    <>
                                        ...
                                        <p>
                                            Si haces una reserva el 25 de agosto para entrar en la habitación el 15 de septiembre hasta el 30 de
                                            junio, se deberá abonar el mes completo ya que pudiera darse el caso de que hubiera una persona que
                                            quisiera entrar antes y la propiedad perdería beneficios.
                                        </p>
                                        <ul className="list-disc pl-4 space-y-1 ml-4 mt-2">
                                            <li>
                                                Si contratas una habitación el día 15 del mes para entrar el 16 pagarás únicamente la parte
                                ...
                                answer: (
                                    <>
                                        <ul className="list-disc pl-4 space-y-1 ml-4 mt-2">
                                            ...
                                            <li>
                                                Cancelaciones realizadas con menos de 30 días de antelación al inicio de contrato, no darán lugar a
                            ...
                            },
                            {
                                ...
                                answer: (
                                    <>
                                        <p>
                                            Sí. Tener un contrato legal, sujeto al código civil, que garantice derechos y obligaciones para cada uno
                                            de nuestros flatmates conlleva un trabajo extra para la agencia.
                                        </p>
                                        <br />
                                        <p>
                                            Por experiencia en nuestra etapa de estudiantes en el extranjero lo consideramos fundamental para la
                                            seguridad y tranquilidad de nuestros inquilinos.
                                        </p>
                                        <br />
                                ...
                                answer: (
                                    <>
                                        <ol className="list-decimal pl-4 space-y-1 ml-4 mt-2">
                                            <li>
                                                Tienes que entrar en www.helloflatmate.com , Registrarte, y cumplimentar todos los datos que te
                                                solicitan para Crear una cuenta. Te llegará un email de confirmación para que actives la cuenta a
                                                través de él.
                                            </li>
                                            <li>
                                        ...
                                        <br />
                                        <p>
                                            Ya está, ya tienes la habitación reservada para ti, a la espera de tus documentos para formalizar el
                                            contrato. Días antes de tu llegada recibirás un email con las instrucciones para el check in.
                                        </p>
                                        <br />
                                ...
                                <AnimatePresence>
                                    {open === index && (
                                        <motion.div
                                            ...
                                            className="text-gris-antracita flex flex-col gap-2 overflow-hidden"
                                        >
                                            {faq.answer}
                                        </motion.div>
                                    )}
                                    ...
                                    {property.category === "HELLO_STUDIO" ? (
                                        ...
                                        property.rooms?.map((room) => (
                                            <article key={room.id} className="flex gap-4 pt-4">
                                                <Image src={room.images[0]} width={130} height={100} alt={room.name} />
                                                <div className="flex flex-col justify-between">
                                                    <h3 className="font-semibold break-words">{room.name}</h3>
                                                    <p className="text-resolution-blue">{formatPrice(room.price) || "No definido"}</p>
                                                </div>
                                            </article>
                                        ))
                                    )}

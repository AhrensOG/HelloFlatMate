...
export default function RoomEditModal({ data, setData, showModal, selectedRoom, category, predefineRental }) {
    ...
    return (
        <aside onClick={() => showModal()} className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50">
            <div onClick={(e) => e.stopPropagation()} className="bg-white p-3 rounded-lg shadow-lg w-full m-3 flex flex-col gap-3 h-[95%] overflow-auto lg:w-[30rem]">

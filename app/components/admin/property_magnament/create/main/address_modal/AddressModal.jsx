...
export default function AddressModal({ data, setData, showModal, category }) {
    ...
    const handleSave = () => {
        if (formData.city.trim() === "" || formData.street.trim() === "" || formData.streetNumber === null || formData.postalCode.trim() === "") {
    ...
    return (
        ...
        >
            <div className="bg-white p-3 rounded-lg shadow-lg w-[17rem] min-h[30rem] lg:w-[25rem]">
                ...
                <div className="flex justify-between w-full mt-4">
                    ...
                    <button onClick={handleSave} className="bg-[#0C1660] text-white px-4 py-2 rounded-lg ml-2">
                        Guardar
                    </button>
                </div>
            </div>

    ...
    return (
        <div className="w-full flex justify-center items-center">
            <div className="flex flex-col w-full gap-6 p-1">
                ...
                <main className={`  px-6 flex flex-col justify-center w-full grow text-[#0D171C]`}>
                    <div className="flex flex-col items-center justify-center gap-[2.5rem]">
                        <div className="w-full flex justify-center gap-4">
                            ...
                            <div className="w-full flex flex-col justify-between gap-6">
                                ...
                                <RentalPeriodTemplate data={rentalPeriods} setData={setRentalPeriods} />
                ...
                {showRoomEditModal && (
                    <RoomAddModal data={dataRoom} setData={setRoomData} showModal={handleShowRoomEditModal} category={catAndSize.category} />
                )}

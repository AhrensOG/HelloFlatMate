                    ...
                    <table className="min-w-full border-collapse rounded-xl relative">
                        <thead>
                            <tr className="sticky top-0 bg-white">
                                ...
                                <th className="border border-t-0 p-2 w-32 text-center font-semibold text-gray-700">Importe</th>
                                ...
                                <th className="border border-t-0 p-2 w-28 text-center font-semibold text-gray-700">¿Activa?</th>
                                <th className="border border-t-0 p-2 w-20 text-center font-semibold text-gray-700">¿Firmada?</th>
                                <th className="border border-t-0 p-2 w-32 text-center font-semibold text-gray-700">¿En revision?</th>
                            </tr>
                        </thead>
                        <tbody>
                            {orders.length > 0 ? (

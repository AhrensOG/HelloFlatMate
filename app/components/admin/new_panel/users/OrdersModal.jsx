                ...
                <table className="w-full border-collapse mt-6 rounded-xl">
                    <thead className="sticky top-0 bg-white">
                        <tr>
                            ...
                            <th className="border border-t-0 p-2 w-32 text-center font-semibold text-gray-700">¿Activa?</th>
                            <th className="border border-t-0 p-2 w-20 text-center font-semibold text-gray-700">¿Firmada?</th>
                            <th className="border border-t-0 p-2 w-28 text-center font-semibold text-gray-700">¿En revisión?</th>

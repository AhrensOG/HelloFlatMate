                        ...
                        {documents?.filter((document) => document.type === "ROSTER").length > 0 ? (
                            <div className="flex flex-wrap gap-4">
                                {documents
                                    ...
                                    .map((document) => (
                                        <div key={document.id} className="flex-shrink-0 border p-2 rounded-lg shadow-md">
                                            {/* Mostrar Información del Documento */}
                                            <p className="font-semibold text-gray-800">{document.name}</p>
                                            <p className="text-sm text-gray-500">{formatDateToDDMMYYYY(document.createdAt)}</p>

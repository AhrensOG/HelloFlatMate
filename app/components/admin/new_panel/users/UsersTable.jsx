        ...
        <table className="w-full overflow-auto">
            <thead className="sticky top-0 bg-white">
                <tr>
                    ...
                    <th className="border border-t-0 p-2 w-full text-center font-semibold text-gray-700">Usuario</th>
                    <th className="border border-t-0 p-2 w-full text-center font-semibold text-gray-700">Email</th>
                    <th className="border border-t-0 p-2 w-full text-center font-semibold text-gray-700">País</th>
                    <th className="border border-t-0 p-2 w-full text-center font-semibold text-gray-700">Fecha Nac.</th>
                    <th className="border border-t-0 p-2 w-full text-center font-semibold text-gray-700">Razón</th>
                    <th className="border border-t-0 p-2 w-full text-center font-semibold text-gray-700">Tel.</th>
                    <th className="border border-t-0 p-2 w-full text-center font-semibold text-gray-700">Ordenes</th>
                    <th className="border border-t-0 p-2 w-full text-center font-semibold text-gray-700">Acciones</th>
                </tr>
            </thead>
            <tbody>

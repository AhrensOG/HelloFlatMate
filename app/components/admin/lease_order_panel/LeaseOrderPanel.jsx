...
export default function LeaseOrderPanel(data) {
    ...
    const [leaserOrders, setLeaserOrders] = useState(
        data.data?.category.name === "HELLO_STUDIO" || data.data?.category.name === "HELLO_LANDLORD" ? data.data?.leaseOrdersProperty : null
    );
    ...
    const aproveLeaseOrder = async (leaseOrder, contract) => {
        try {
            const dataRequest = {
                ...
                action: "APPROVED",
                propertyId: property.category.name === "HELLO_STUDIO" || property.category.name === "HELLO_LANDLORD" ? property.id : null,
                type: property.category.name === "HELLO_STUDIO" || property.category.name === "HELLO_LANDLORD" ? "PROPERTY" : "ROOM",
                roomId: property.category.name === "HELLO_STUDIO" || property.category.name === "HELLO_LANDLORD" ? null : leaseOrder.roomId,
            };
                ...
                <AnimatePresence>
                    {showCurrentLeaseOrder && (
                        ...
                        >
                            ...
                            {property?.category.name === "HELLO_STUDIO" && leaserOrders?.length > 0 ? (
                                leaserOrders

...
export default function CreateLeaseOrderModal({ data, onClose }) {
    ...
    const filterUsers = (value) => {
        ...
        return data?.users.filter((user) => user.email.toLowerCase().includes(value.toLowerCase()));
    };
    ...
    const handleSelectProperty = (property) => {
        ...
        const filteredRooms = rooms.filter(
            (room) =>
                property.category.name === "HELLO_COLIVING" || property.category.name === "HELLO_ROOM" || property.category.name === "HELLO_LANDLORD"
        );
    ...
    const createLeaseOrder = async () => {
        try {
            ...
            if (selectedProperty.category.name !== "HELLO_STUDIO" && selectedRoom) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white rounded-lg shadow-lg p-6 w-96">
                ...
                {selectedProperty !== false && selectedProperty?.category.name !== "HELLO_STUDIO" && (
                    <div className="mb-4">
          ...
          />
                ...
                <div className="flex justify-end">
                    <button onClick={handleSubmit} className="bg-blue-500 text-white px-4 py-2 rounded-lg shadow-sm hover:bg-blue-600">

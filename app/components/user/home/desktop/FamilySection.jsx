  ...
  return (
    <section className="relative w-full flex items-center justify-center">
      ...
      <div className="relative w-full sm:w-5/6 h-[350px] sm:h-[500px]">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-6 p-6 sm:max-w-[75%] text-white h-full">
          ...
          <p className="font-normal text-[18px] leading-[27px] text-center sm:text-center md:text-2xl">
            En Helloflatmate, no solo encontrarás un lugar para vivir, sino
            también una comunidad vibrante de estudiantes como tú. Aquí,
            compartimos más que espacio; compartimos experiencias, sueños y
            metas. Vive con personas que entienden tus desafíos y celebran tus
            logros.
          </p>
        </div>
      </div>
      ...
      <div className="absolute z-20 hidden sm:block left-2/3 -translate-x-1/2 top-1/2 -translate-y-1/2">
        <Image
          src="/home/subFamily1.svg" // Cambia esta ruta por la imagen superpuesta que quieras usar

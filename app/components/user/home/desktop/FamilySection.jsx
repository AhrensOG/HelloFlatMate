...
export default function FamilySection() {
    const t = useTranslations("hellostudio_page.family");
    const data = {
        helloroom: {
            title: "hellorooms",
            description: t("helloroom_desc_1"),
            description2: t("helloroom_desc_2"),
            img1: "/home/family2.svg",
            img2: "/home/subFamily2.svg",
        },
        hellolandlord: {
            title: "hellolandlord",
            description: t("hellolandlord_desc_1"),
            description2: t("hellolandlord_desc_2"),
            img1: "/home/family1.svg",
            img2: "/home/subFamily1.svg",
        },
        hellostudio: {
            title: "hellostudios",
            description: t("hellostudio_desc_1"),
            description2: t("hellostudio_desc_2"),
            img1: "/home/family4.svg",
            img2: "/home/subFamily4.svg",
        },
        hellocoliving: {
            title: "hellocoliving",
            description: t("hellocoliving_desc_1"),
            description2: "",
    ...
    return (
        <section className="relative w-full flex items-center justify-center overflow-hidden">
            ...
            >
                <Image src={img1} alt="Personas jugando en una comunidad" fill className="object-cover" quality={100} priority />
            ...
            >
                <motion.div
                    ...
                    transition={{ duration: 0.8 }}
                >
                    <Image src={img2} alt="Imagen superpuesta" width={400} height={400} quality={100} priority />
                </motion.div>
            </motion.div>
            ...
            <div className="absolute bottom-0 sm:bottom-auto sm:right-10 sm:top-1/2 transform -translate-y-1/2 z-30 flex sm:flex-col flex-row gap-4">
                {sectionKeys.map((key) => (
                    <button
                        ...
                        className={`w-3 h-3 rounded-full ${activeSection === key ? "bg-black scale-150" : "bg-black"}`}
                    ></button>
                ))}
            </div>
        </section>

            ...
            <div className="relative">
                <div className="relative w-full h-80 md:h-[750px] z-10">
                    {img.includes("youtube.com") ? (
                        ...
                        <iframe
                            src={`https://www.youtube.com/embed/${img.split("v=")[1]}?autoplay=1&mute=1&controls=0&showinfo=0&loop=1&playlist=${
                                img.split("v=")[1]
                        ...
                        <iframe
                            src={`https://player.vimeo.com/video/${img.split("/").pop()}?autoplay=1&muted=1&loop=1&background=1#t=${startTime}s`} // Añadimos el startTime aquí
                            title="Vimeo Video"
                            className="w-full h-full object-cover"
                            allow="autoplay; encrypted-media"
                            allowFullScreen
                        ...
                        // Si es una imagen
                        <Image src={img} alt="Fondo de Hero" fill quality={100} className="object-cover" />
                    )}
                ...
                <div className="absolute w-full inset-0 z-20 flex flex-col items-center justify-center text-center text-white">
                    <div className="w-2/3 flex flex-col items-center justify-center gap-20 sm:gap-24 md:gap-52">
                        ...
                        <div className="flex flex-col justify-center items-center">
                            <h1 className="font-extrabold text-4xl md:text-7xl leading-none tracking-[-1px]">{title}</h1>

                            {/* Subtítulo */}
                            <p className="mt-4 font-semibold text-[16px] md:text-[24px] leading-tight">{description}</p>
                        </div>

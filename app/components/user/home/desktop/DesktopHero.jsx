  ...
  return (
    <section className="w-full">
      ...
      <div className="relative">
        <div className="relative w-full h-72 md:h-96 lg:h-[420px] z-10">
          <Image
            src="/home/DesktopHero.jpg"
            alt="Fondo de Hero"
            fill
            quality={100}
        ...
        <div className="absolute w-full inset-0 z-20 flex flex-col items-center justify-center text-center text-white">
          {/* Título principal */}
          <h1 className="font-extrabold text-5xl md:text-7xl leading-none tracking-[-1px]">
            helloflatmate
          </h1>

          {/* Subtítulo */}
          <p className="mt-4 font-semibold text-[18px] md:text-[24px] leading-tight">

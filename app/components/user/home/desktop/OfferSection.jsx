        ...
        <div className="relative w-full sm:w-5/6 z-10 flex flex-col items-start justify-center p-6 md:p-12 mt-4 ml-8 md:mt-8 md:ml-12 bg-[#1FAECC] md:text-left md:items-start">
          <div className="flex flex-col w-full sm:w-2/3 md:w-4/5 text-center">
            ...
            <h2 className="font-extrabold text-[26px] leading-[30px] tracking-[-1.5px] mb-4 sm:text-3xl md:text-4xl">
              Descubre nuestras increíbles habitaciones
            </h2>

            {/* Descripción */}
            <p className="font-normal text-[18px] leading-[24px] mb-8 sm:text-2xl md:text-3xl">
              ¿Buscas un lugar cómodo y accesible para vivir? En Helloflatmate,
              ofrecemos habitaciones modernas y bien equipadas que se adaptan a
              tus necesidades y presupuesto. Con nosotros, tu nuevo hogar está a

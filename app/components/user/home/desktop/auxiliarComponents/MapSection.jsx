  ...
  return (
    <div className="flex justify-center items-center w-full p-2 py-10">
      <div className="flex flex-col w-full max-w-screen-lg items-center justify-center gap-16 bg-white">
        ...
        <h1 className="text-4xl font-medium">La mejor ubicación</h1>
            ...
            >
              ...
              <div>
                ...
                <p className="text-black text-lg">
                  Los miembros de la comunidad de helloflatmate no son los
                  únicos con ansias de viajes... Echa un vistazo a algunas de
                  las nuevas ciudades donde pronto podrás encontrar a la
                  comunidad. Algunos lugares están en construcción, otras en
                  fase de planificación y desarrollo, y otras están en fase de
                  investigación.
                </p>
              </div>
            </div>
            <div className="p-8 bg-[#b2d4ff]">
              <p className="mb-2 font-bold text-black">Here’s what’s</p>
              <div className="flex justify-center items-center gap-4">
                <button className="bg-blue-500 text-white font-bold py-2 px-4 rounded text-sm">
                  ¡Open now!
                </button>
                <span className="font-bold text-lg text-black">&</span>
                <button className="bg-black text-white font-bold py-2 px-4 rounded text-sm">
                  ¡Coming soon!
                </button>
              </div>
            </div>

...
export default function DesktopFilter({ isOpen, setOpen, filters, setFilters, onApplyFilters, onFilterChange, category, rentalPeriods }) {
    ...
    const typeProperty = ["helloroom", "hellocoliving", "hellostudio", "hellolandlord"];
            ...
            >
                ...
                <div className="space-y-6 px-4">
                    <section className="flex flex-col gap-3">
                        <h2 className="text-[1.37rem] font-bold text-[#1C1C21]">Ubicacion</h2>
                    ...
                    {filters.categorys?.length === 1 && (filters.categorys[0] === "hellostudio" || filters.categorys[0] === "HELLO_STUDIO") ? (

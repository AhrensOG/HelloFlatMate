        ...
        >
            ...
            >
                <div className="flex justify-center sm:justify-start items-center mb-2">
                    <button className="w-10 h-10 hidden sm:flex items-center justify-center " onClick={callback}>
                ...
                <h2 className="text-xl font-semibold mb-4 w-full text-center">Datos de solicitud para reserva</h2>

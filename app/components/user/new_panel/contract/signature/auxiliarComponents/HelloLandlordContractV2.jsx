  ...
  return (
    <div className="w-full grid place-items-center">
      <div className="container mx-auto max-w-screen-lg max-h-max overflow-y-auto w-full text-justify">
        ...
        <p className="mb-4 text-sm font-light">
          De una parte,{" "}
          <span className="font-semibold">D./Dª {landlordName}</span>, como
          parte ARRENDADORA, siendo mayor de edad, con NIF {landlordNIF},
        ...
        <p className="mb-4 text-sm font-light">
          De otra parte,{" "}
          <span className="font-semibold">D./Dª {tenantName}</span>, mayor de
          edad, con D.N.I o pasaporte{" "}
          <span className="font-semibold">{tenantID}</span>, nº de teléfono{" "}
          <span className="font-semibold">+{tenantPhone}</span>, email{" "}
          <span className="font-semibold">{tenantEmail}</span>, y con domicilio
          en <span className="font-semibold">{tenantAddress}</span>, C/{" "}
        ...
        <p className="mb-4 text-sm font-light">
          ...
          estancia, ésta tendrá un coste de{" "}
          <span className="font-semibold">35 €</span>, y siempre estará
        ...
        <div className="mb-4 text-sm font-light">
          ...
          gastos relativos a los suministros de agua, luz e internet.
          {roomNumber?.startsWith("CPDF49P4") ||
          roomNumber?.startsWith("CC9P8") ? (
            <p className="mb-4 text-sm font-light">
              El pago de la renta mensual se realizará en efectivo, con la
              visita al piso por el agente de la zona mediante cita previa.
            </p>
          ) : (
            <p className="mb-4 text-sm font-light">
              Dicha renta se abonará mediante transferencia bancaria o ingreso
              en la siguiente cuenta de EL ARRENDADOR, indicando en el concepto
          ...
          acciones originen. El ARRENDATARIO es conocedor y asume que en caso de
          impago de las rentas deberá abandonar la vivienda, perdiendo las
        ...
        <p className="mb-4 text-sm font-light">
          ...
          mes de contrato, <span className="font-semibold">50 €</span> para la
          limpieza profunda de la vivienda. No obstante, el ARRENDATARIO deberá
          dejar la habitación, así como las zonas comunes totalmente limpias y
          sin enseres personales. En ese sentido, el ARRENDATARIO se
          responsabiliza solidariamente junto a sus compañeros a dejar la
        ...
        <p className="mb-4 text-sm font-light">
          ...
          concepto de suministros de agua y luz por cada período de CINCO MESES
          de contrato. Una vez transcurrido dicho periodo, se calculará el
          importe exacto a abonar por parte del ARRENDATARIO en concepto de
        ...
        <p className="mb-4 text-sm font-light">
          ...
          contrato. Para los contratos de 10 meses, a final de enero, junto a la
          renta de febrero, se hará otra aportación para los siguientes 5 meses
          de contrato para los suministros y wifi.
        </p>
        <h3 className="text-sm font-bold mb-2">

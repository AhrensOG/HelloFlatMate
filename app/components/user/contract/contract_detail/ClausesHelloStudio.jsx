  ...
  return (
    <div className="flex flex-col text-sm leading-relaxed text-gray-800">
      ...
      <p className="mb-4 font-light break-words">
        ...
        descrita en este contrato. El destino pactado para la edificación es de
        Uso distinto al de vivienda y concretamente la residencia temporal del{" "}
      ...
      <p className="mb-4 font-light break-words">
        ...
        encuentren en zonas comunes como en la habitación alquilada. Una vez
        transcurrido este período sin que el{" "}
      ...
      <p className="mb-4 font-light break-words">
        ...
        incumplimiento con 10€ por cada día de retraso en el pago. El{" "}
        <span className="font-medium">ARRENDATARIO</span> estará obligado a
      ...
      <ul className="list-disc ml-5 mb-4 font-light space-y-2">
        <li>
      ...
      <p className="mb-4 font-light break-words">
        ...
        febrero, se hará otra aportación para los siguientes 5 meses de contrato
        para los suministros y wifi.
      </p>
      ...
      <p className="mb-4 font-light break-words">
        ...
        de desahucio del arrendatario, siendo este responsable de los daños y
        perjuicios que el impedimento de acceso a la vivienda pueda ocasionar al
        arrendador, entre otros la pérdida de beneficios por no poder arrendar
        otras habitaciones.
      </p>
      ...
      <p className="mb-4 font-light break-words">
        ...
        sea helloflatmate quien gestione la tramitación del empadronamiento ante
        las autoridades, el <span className="font-medium">ARRENDATARIO</span>{" "}
        deberá abonar un suplemento de 150 €. En todo caso, una vez finalizado
        el arrendamiento, el <span className="font-medium">ARRENDATARIO</span>{" "}
        se obliga a presentar ante la OFICINA DEL PADRÓN MUNICIPAL la solicitud
      ...
      <h3 className="font-bold mb-2 text-left uppercase text-sm">
        DÉCIMOTERCERA. - OBLIGACIONES DEL ARRENDADOR Y ARRENDATARIO CON RESPECTO
      ...
      <p className="mb-4 font-light break-words">
        ...
        del resto de dependencias de la vivienda. El arrendatario no podrá hacer
      ...
      <p className="mb-4 font-light break-words">
        ...
        del Código Civil. Además, el{" "}
        <span className="font-medium">ARRENDADOR</span> podrá resolver de pleno
        Derecho el contrato por las siguientes causas:
      </p>
      <ul className="list-none mb-4 font-light space-y-1">
        <li>
        ...
        <li>b) La falta de pago del importe de la fianza.</li>
        <li>
...
export default ClausesHelloStudio;

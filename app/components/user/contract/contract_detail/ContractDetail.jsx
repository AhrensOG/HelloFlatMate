      ...
      <div className="w-full grid place-items-center">
        <div className="container mx-auto p-4 max-w-screen-sm max-h-[50vh] overflow-y-scroll w-full text-justify">
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            entenderá que la vivienda se encontraba en perfecto estado para su
            uso y habitabilidad, debiendo devolverla el arrendatario a la
            finalización del contrato en ese mismo estado.
          </p>
          <h3 className="text-sm font-bold mb-2 text-left">
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            de que el <span className="font-medium">ARRENDATARIO</span>{" "}
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            <span className="font-medium">ARRENDATARIO</span> los gastos que
            estas acciones originen. El{" "}
            <span className="font-medium">ARRENDATARIO</span> es conocedor y
            ...
            así como suministros de agua, luz, gas e internet. Del mismo modo,
            para el caso de que el arrendatario incumpla el plazo de pago de la
            renta, el <span className="font-medium">ARRENDADOR</span> podrá
            sancionar al <span className="font-medium">ARRENDATARIO</span> por
            dicho incumplimiento con 10€ por cada día de retraso en el pago.
          </p>
          <p className="mb-4 text-sm break-words font-light">
            El <span className="font-medium">ARRENDATARIO</span> estará obligado
            a abonar junto a la renta del último mes de contrato, 50 € para la
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            de suministros. El <span className="font-medium">ARRENDATARIO</span>{" "}
            ...
            MoneyGram…etc.). Para el caso de que se encuentren desperfectos en
            la revisión que en su día se efectúe, así como recibos impagados por
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            internet por los primeros cinco meses de contrato. Para los
            contratos de 10 meses, a final de enero, junto a la renta de
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            acceso a la vivienda. En caso de que se vaya a efectuar una visita
            ...
            arrendatario. La violación de este derecho del arrendador por parte
            de cualquier persona que se encuentre en la vivienda será
            considerada causa de resolución del contrato de arrendamiento y
            motivo de desahucio del{" "}
            <span className="font-medium">ARRENDATARIO</span>, siendo este
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            reducción de la renta pactada. Entiéndase por fuerza mayor, a los
            efectos de este contrato, toda circunstancia que tenga carácter
            imprevisible e inevitable que afecte al cumplimiento de las
            obligaciones contractuales, tales como, ad exemplum, acontecimientos
            naturales extraordinarios como inundaciones, terremotos, caída de
            rayos, situaciones de epidemia y pandemia. Se exime al{" "}
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            contrato personal e intransferible. El incumplimiento de esta
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            encuentra en la fecha de finalización del presente contrato, y con
            el mismo formato de entrega (con arandela y código de habitación).
            ...
            concepto de cláusula penal, además de todos los gastos que directos
            e indirectos que dicho retraso generen de cara a la recuperación de
            la vivienda y de la habitación.
          </p>
          <h3 className="text-sm font-bold mb-2 text-left">
            DECIMOPRIMERA. – EMPADRONAMIENTO.
          </h3>
          <p className="mb-4 text-sm break-words font-light">
            El <span className="font-medium">ARRENDATARIO</span> tendrá derecho
            a empadronarse en la vivienda compartida, siempre y cuando, cumpla
            con los requisitos exigidos en la normativa local de referencia. Los
            contratos de arrendamiento de habitación cuya duración sea inferior
            ...
            arrendamiento, el <span className="font-medium">ARRENDATARIO</span>{" "}
            se obliga a presentar ante la OFICINA DEL PADRÓN MUNICIPAL la
            solicitud de Baja. Si no lo hiciera, y no hubiera abonado el
            suplemento previsto en concepto de gestión, se descontarán del
            depósito 50 €.
          </p>
          <h3 className="text-sm font-bold mb-2 text-left">
          ...
          <p className="mb-4 text-sm break-words font-light">
            La parte <span className="font-medium">ARRENDATARIA</span> se
            someterá durante toda la vigencia del contrato a las normas
            establecidas por la comunidad de propietarios, especialmente las
            relativas a la convivencia, las obligaciones recogidas en la Ley
            49/1960, de 21 de julio, sobre Propiedad Horizontal, y
            particularmente las normas incluidas en el ANEXO I del presente
            contrato, del que forma parte inseparable.
          </p>
          <h3 className="text-sm font-bold mb-2 text-left">
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            habitabilidad para servir al uso convenido, salvo cuando el
            deterioro o reparación sea imputable al arrendatario a tenor de lo
            dispuesto los artículos 1.563 y 1.564 del Código Civil. Las pequeñas
            reparaciones que exija el desgaste por el uso ordinario de la
            vivienda correrán por cuenta del{" "}
            ...
            fregaderos, atascos en el WC, atascos en las persianas, rociador de
            la manguera de la ducha, etc. Es obligación del{" "}
            ...
            agujeros en las paredes o puertas, así como tampoco podrá hacer uso
            de pegamentos o gomas adhesivas que puedan manchar o dañar las
            paredes o puertas. Las reparaciones e incidencias serán abonadas por
            parte del <span className="font-medium">ARRENDATARIO</span> al
            técnico encargado en el momento de su intervención. En caso de que
            las mismas corran a cargo del{" "}
            <span className="font-medium">ARRENDADOR</span>, éste se las abonará
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            cumplido las suyas a exigir el cumplimiento de la obligación o a
            promover la resolución del contrato de acuerdo con lo dispuesto en
          ...
          <p className="mb-4 text-sm break-words font-light">
            ...
            de la ciudad de Valencia para todas aquellas cuestiones litigiosas
            que pudieran derivarse del presente contrato, por ser el lugar donde
            se encuentra la habitación arrendada.
          </p>
          <p className="mb-4 text-sm break-words font-light">
          ...
          <ol className="list-decimal ml-6 mb-4 text-sm break-words font-light">
            <li className="mb-4">
              ...
              contrato a las normas establecidas por la comunidad de
            ...
            <li className="mb-4">
              ...
              <ul className="list-disc ml-6">
                <li>
                  ...
                  humana o la actividad directa de las personas, movimiento de
                  muebles y/o enseres, etc». Entra dentro de esta categoría usar
                  aparatos e instrumentos musicales o acústicos, radio,
                ...
                <li>
                  ...
                  ruidos» molestos; se pone el ejemplo de un taladro. Además,
                  «la posesión de animales sin adoptar las medidas necesarias
                  para evitar que los ruidos producidos por éstos ocasionen
                  molestias a los vecinos». Estos comportamientos son
            ...
            <li className="mb-4">
              ...
              arrendatarios de la vivienda, incluyendo el cumplimiento de los
              turnos de limpieza de zonas comunes, baños y cocina, bajar la
              basura y las tareas domésticas básicas.
            </li>
            <li className="mb-4">
              Queda prohibida expresamente la tenencia de cualquier tipo de
            ...
            <li className="mb-4">
              ...
              <ul className="list-disc ml-6">
                ...
                <li>
                  ...
                  cualquier dependencia de la vivienda y el consumo de
                  sustancias estupefacientes. En caso de denuncia por parte del
                  resto de arrendatarios o vecinos, el arrendador podrá resolver
                  el contrato con pérdida de fianza y suministros.
                </li>
                <li>
                  ...
                  <ul className="list-disc ml-6">
                    ...
                    <li>
                      Tercer aviso expulsión con pérdida de fianza, suministros
                      y wifi.
                    </li>
                  </ul>
                </li>
                <li>
                  El arrendatario da su consentimiento expreso para compartir
                  las zonas comunes con personas de distinto género, etnia,
            ...
            <li className="mb-4">
              ...
              la agencia, trabajadores de mantenimiento y limpieza, o
              compañeros.
            </li>
            <li className="mb-4">
              El arrendatario no podrá usar habitaciones no arrendadas. En caso
              de hacerlo, podrá ser detraído el 100% de la fianza.
            </li>
            <li className="mb-4">
            ...
            <li className="mb-4">
              ...
              noches y no pueden coincidir más de 3 invitados simultáneamente.
              Si el invitado supera las 3 noches, deberá contribuir con 20
              €/semana para gastos comunes. Los visitantes no pueden dormir en
              zonas comunes ni cuando su anfitrión esté fuera de la ciudad.
            </li>
            <li className="mb-4">
              En caso de pérdida de llaves o no entrega a la finalización del
              contrato, se abonarán los gastos por cambio de cerradura y juego
              de llaves.
            </li>
            <li className="mb-4">
              Al finalizar el contrato, el arrendatario deberá dejar la
              habitación y zonas comunes limpias y sin enseres personales. Si se
              causan desperfectos y el causante no se identifica, todos los
              inquilinos responderán solidariamente con sus fianzas.
            </li>
          </ol>
        </div>

...
const ContractDetail = ({ handleContinue, handleBack, owner, property }) => {
                ...
                if (property && leaseOrderId) {
                    if (roomId) {
                        ...
                        if (foundRoom) {
                            ...
                            const foundLeaseOrder = foundRoom.leaseOrdersRoom.find((order) => order.id === parseInt(leaseOrderId));
                        ...
                        const foundLeaseOrder = property.leaseOrdersProperty.find((order) => order.id === parseInt(leaseOrderId));
                        setLeaseOrder(foundLeaseOrder || null);
                    }
                }
            } catch (error) {
    ...
    const startDate = leaseOrder?.startDate ? parseDate(leaseOrder.startDate) : "1 de septiembre de 2024";
    const endDate = leaseOrder?.endDate ? parseDate(leaseOrder.endDate) : "31 de agosto de 2025";

...
import { CalendarDaysIcon, CameraIcon, PencilSquareIcon } from "@heroicons/react/24/outline";
...
export default function WorkerProfileInfo() {
    ...
    const t = useTranslations("worker_panel.tasks.profile");
    ...
    return (
        <>
            ...
            <main className={`  flex flex-col items-center gap-5 w-full p-4`}>
          ...
          >
            <ArrowLeftIcon />
                    ...
                    <h2 className=" text-[#000000CC] font-bold text-xl lg:text-center lg:self-center w-full">{t("title_2")}</h2>
                </section>
                <div className=" lg:w-[30rem] flex flex-col gap-6">
                    <div className="flex flex-col gap-2 items-center justify-center">
                        <div className="relative h-32 w-32 rounded-full bg-[#875252] overflow-hidden">
                            <Image src={user?.profilePicture} fill alt="Profile image" className="object-cover object-top h-full w-full" />
            ...
            <p className="underline text-[#000000B2] font-semibold text-xs">
              Cambiar foto
                    ...
                    <ProfileItems title={t("items.title_1")} body={user?.name + " " + user?.lastName} icon={<PencilSquareIcon />} />
                    {/* <ProfileItems
            title={"Genero"}
          ...
          /> */}
                    <ProfileItems title={t("items.title_2")} body={t("items.body_2")} icon={<ChevronDownIcon />} />
                    {/* <ProfileItems

...
export default function LocationSection({}) {
    const t = useTranslations("worker_panel.tasks.task_details.loc_sec");
    return (
        <article className="flex flex-col gap-2 text-center w-full lg:w-[45%]">
            <h3 className="font-semibold text-base text-black">{t("h3")}</h3>
            <div className="flex gap-2 items-center text-[#000000E5] justify-center">
                <span className=" w-5 h-6 ">
                    <MapPinIcon />
                </span>
                <p className="font-medium text-base opacity-75">{t("p")}</p>
            </div>

    ...
    <div className="w-full flex flex-col justify-center items-start space-y-2">
          ...
          <div className="flex flex-row w-full overflow-x-scroll gap-2 shadow-profile">
            <ChatCard
              ...
              title="New Chat"
            />
            <ChatCard image="/profile/profile.jfif" title="Tobi Lateef" />
            <ChatCard image="/profile/profile.jfif" title="Queen Needle" />
            <ChatCard image="/profile/profile.jfif" title="Joan Blessing" />
          </div>
        </div>
  )
}

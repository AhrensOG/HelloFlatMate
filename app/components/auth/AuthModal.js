                ...
                >
                    ...
                    >
                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 overflow-auto flex flex-col" style={{ height: '80vh' }}>
                            ...
                            <h1 id="modal-title" className={`${poppins.className} pb-3 text-center text-xl font-semibold leading-6 text-gris-antracita`}>
                                Hello Flamate Términos de Uso
                            </h1>
                            <section id="modal-description" className={`${plus_jakarta.className} mt-2 font-normal text-sm flex flex-col gap-2 items-center`}>
                                <p>
